...
export const TrainerControls = forwardRef<HTMLDivElement, TrainerControlsProps>(
  function TrainerControls(
    ...
    const showRatings = isSrs && revealed && ratingPreviews

    return (
      <div
        ref={ref}
        className={`trainer-controls${showRatings ? ' trainer-controls--ratings' : ''}`}
      >
